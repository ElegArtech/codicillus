...
ARCHIVE="codicillus-$VERSION-compose.tar.gz"
URL="https://github.com/ElegArtech/codicillus/releases/download/v$VERSION"
printf 'Téléchargement de Codicillus %s…\n' "$VERSION"
...
bash "$DOSSIER/outils/configurer.sh"
