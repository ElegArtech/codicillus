<script lang="ts">
	/**
	 * `/console/types-de-fiches` — V-29 Console · Types de fiches. Le rôle
...
<!--
	...
	DEUX GESTES, ET LE SECOND EST CELUI QUE LE REFUS PROPOSE : `RG-M14-06` refuse la
	suppression d'un type employé et exige que le refus porte une sortie — le gel
	l'offre en « Délester ces N notes », et `P-03` interdit qu'elle soit inerte. Les
	deux désignent le type par son identifiant lisible : un libellé se renomme, un
	identifiant est stable.
-->
<Vue
