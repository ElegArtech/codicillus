<script lang="ts">
	 ...
	 * (« Carte mentale — vue V-21 », rail de la coquille), et `docs/routes.md` §3 — qui fait foi sur les chemins — la
	 * résout en `/carte-mentale` → V-21.
	 *
	 ...
	 * (`/__design/V-21?etat=…`), qui rend le composant directement. Rien de ce
...
<Vue vecteur={null} notes={corpusPourVue('V-21')} />
