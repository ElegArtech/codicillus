<script lang="ts">
	 ...
	 * (« Import — vue V-24 », rail de la coquille), et `docs/routes.md` §3 — qui fait foi sur les chemins — la
	 * résout en `/importer` → V-24.
	 *
...
<Vue vecteur={null} notes={corpusPourVue('V-24')} />
