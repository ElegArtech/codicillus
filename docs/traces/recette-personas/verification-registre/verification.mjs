...
const chemin = await cloner('/tmp/codicillus_recette9_mtv40vd1/configuration.json', 'verification_registre', 'garnie', 5920);
const session = await ouvrirNavigateur(chemin, 'contributeur', 'verification-registre');
