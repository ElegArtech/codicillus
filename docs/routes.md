...
| `/modelisation` | Modélisation — ce qui dépend de quoi | connecté ; périmètre rabattu sans droit | — | — | S4 rail `Outils › Modélisation` |
...
|---|---|---|
| Routes servant une vue | **36** | −3 : V-38, V-39 et V-40 cessent d'être des routes (ARB-002) ; +1 : `/modelisation`, qui n'a pas de planche |
...
| **Total des routes** | **41** | −4 par ARB-002, +1 pour `/modelisation` |
